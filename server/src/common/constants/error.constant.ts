...
export const AUTH_CREDENTIALS_INVALID = '400025: Authentication credentials were missing or incorrect';
export const PRISMA_API_ERROR = '400023: Prisma API error';
export const ROLE_NOT_FOUND = '404018: Role not found';
export const UPLOAD_S3_FAILED = '400033: Uploaded file failed'
...
export const UPDATE_PROFILE_CONFLICT = '409006: User email or phone is not verified';
...
export const USER_NOT_VERIFIED = '403031: User is not verified';
export const USER_NOT_ACTIVE = '403032: User is not active';

export const USER_MULTI_LOGIN = '403034: Please contact Admin to reset device or request multiple device login'
...
export const CODE_ACTIVATION_NOT_FOUND = '404033: Code Activation not found';
export const MFA_PHONE_NOT_FOUND = '400003: Phone number not found';
export const RECEPIENT_ACCOUNT_TRANSFER = '800001: Recepient Account Not Found'
...
export const ORGANIZATION_TYPE_TOURNAMENT = '400029: Organization type should be tournament';
...
export const TEAM_TOURNAMENT_CONFLICT = '409016: Team is already in tournament event';
export const ORGANIZATION_VERIFIED_CONFLICT = '409017: Organization is already verified';
export const STAT_ALREADY_COLLECTED = '409021: Can not collect statistics twice';
export const STAT_NOT_COLLECTED = '409022: Can not discard statistics: it was not collected';
export const FOLLOW_REQUEST_ALREADY_EXISTS = '409023: Follow request already exists';
...
export const THIRDPARTY_API_ERROR = '400401: Thirdparty API Error Body';
export const BALANCE_NOT_ENOUGH = '800000: Your Balance Are Not Enough';